...
BASE_SCRIPTS= [
    ...
    #'p2p_pos_fakestake.py', # Not Working -- TODO needs staking
    'p2p_pos_fakestake_accepted.py',
    #'p2p_zpos_fakestake.py', # Not Working -- TODO needs staking
    #'p2p_zpos_fakestake_accepted.py', # Not Working -- TODO needs staking
    #'zerocoin_wrapped_serials.py', # Not Working needs staking TODO needs staking
    ...
    #'wallet_txn_doublespend.py --mineblock', # Not Working -- TODO Fix it
    'wallet_txn_clone.py',
    ...
    'feature_proxy.py',
    #'rpc_signrawtransaction.py', # Not Working -- TODO Fix it
    'p2p_disconnect_ban.py',
    'rpc_decodescript.py',
    'rpc_blockchain.py',
    #'rpc_deprecated.py', # Not Working -- TODO Fix it
    'wallet_disable.py',
...
EXTENDED_SCRIPTS = [
    ...
    # vv Tests less than 5m vv
    # vv Tests less than 2m vv
    #'p2p_timeouts.py', # Not Working -- TODO p2p peer does not timeout
    # vv Tests less than 60s vv
