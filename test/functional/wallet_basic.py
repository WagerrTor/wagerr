...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(walletinfo['immature_balance'], 173610471)
        ...
        assert_equal(self.nodes[0].getbalance(), 173610471)
        ...
        assert_equal(self.nodes[0].getbalance(), 173610471+250000-21)
        ...
        assert_equal(self.nodes[0].getbalance(), 173860450)
        ...
        assert_equal(self.nodes[0].getbalance(), Decimal('173860460'))
        ...
        assert_equal(node_0_bal, Decimal('173860470'))
